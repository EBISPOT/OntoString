...
import uk.ac.ebi.spot.ontostring.util.GraphRestrictionUtil;
...
import uk.ac.ebi.spot.ontostring.exception.BadRequestException;
import uk.ac.ebi.spot.ontostring.rest.assembler.ProjectContextDtoAssembler;
import uk.ac.ebi.spot.ontostring.rest.assembler.ProjectDtoAssembler;
