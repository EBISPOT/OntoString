...
import uk.ac.ebi.spot.ontostring.constants.AuditEntryConstants;
...
import uk.ac.ebi.spot.ontostring.rest.assembler.MappingDtoAssembler;
import uk.ac.ebi.spot.ontostring.rest.dto.mapping.MappingCreationDto;
...
public class MappingsController {
    ...
    public MappingDto getMapping(@PathVariable String projectId, @RequestParam(value = CurationConstants.PARAM_ENTITY_ID) String entityId, HttpServletRequest request) {
        ...
        uk.ac.ebi.spot.ontostring.domain.mapping.Mapping mapping = mappingService.retrieveMappingForEntity(entity.getId());
        if (mapping == null) {
            return null;
        }
    ...
    public MappingDto createMapping(@PathVariable String projectId, @RequestBody @Valid MappingCreationDto mappingCreationDto, HttpServletRequest request) {
         ...
         */
        uk.ac.ebi.spot.ontostring.domain.mapping.Mapping existingMapping = mappingService.retrieveMappingForEntity(entity.getId());
         ...
         * Create new mapping.
         */
        uk.ac.ebi.spot.ontostring.domain.mapping.Mapping created = mappingService.createMapping(entity, ontologyTerms, provenance);
    ...
    public MappingDto updateMapping(@PathVariable String projectId, @PathVariable String mappingId, @RequestBody @NotEmpty @Valid MappingDto mappingDto, HttpServletRequest request) {
        ...
        uk.ac.ebi.spot.ontostring.domain.mapping.Mapping existing = mappingService.retrieveMappingById(mappingId);
        ...
        uk.ac.ebi.spot.ontostring.domain.mapping.Mapping updated = mappingService.updateMapping(mappingId, newTerms, oldTerms, provenance);
