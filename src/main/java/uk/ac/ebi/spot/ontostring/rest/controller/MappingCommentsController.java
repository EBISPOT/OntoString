...
import uk.ac.ebi.spot.ontostring.rest.assembler.CommentDtoAssembler;
...
public class MappingCommentsController {
    ...
    public CommentDto createComment(@PathVariable String projectId, @PathVariable String mappingId,
        ...
        uk.ac.ebi.spot.ontostring.domain.mapping.Mapping mapping = mappingService.addCommentToMapping(mappingId, body, provenance);
