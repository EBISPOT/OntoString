...
import uk.ac.ebi.spot.ontostring.rest.assembler.ReviewDtoAssembler;
...
public class MappingReviewsController {
    ...
    public ReviewDto createReview(@PathVariable String projectId, @PathVariable String mappingId,
        ...
        uk.ac.ebi.spot.ontostring.domain.mapping.Mapping mapping = mappingService.addReviewToMapping(mappingId, comment,
