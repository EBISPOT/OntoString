...
public abstract class IntegrationTest {
    ...
    protected void createEntityTestData(String sourceId, String projectId, User user) {
        ...
        OntologyTerm orphaTerm = ontologyTermRepository.insert(new OntologyTerm("Orphanet:15", "http://www.orpha.net/ORDO/Orphanet_15",
        ...
        OntologyTerm mondoTerm = ontologyTermRepository.insert(new OntologyTerm("MONDO:0007037", "http://purl.obolibrary.org/obo/MONDO_0007037",
