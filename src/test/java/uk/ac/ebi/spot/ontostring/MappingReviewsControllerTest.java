...
public class MappingReviewsControllerTest extends IntegrationTest {
    ...
    public void setup() throws Exception {
        ...
        ProjectDto projectDto = super.createProject("New Project", user1, datasources, ontologies, "efo", 3, null);
    ...
    public void shouldCreateReview() throws Exception {
        ...
        Assert.assertEquals("New review", mapping.getReviews().get(0).getComment());
