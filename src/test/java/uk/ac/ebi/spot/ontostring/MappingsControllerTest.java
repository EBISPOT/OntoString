...
import uk.ac.ebi.spot.ontostring.constants.*;
import uk.ac.ebi.spot.ontostring.domain.Project;
import uk.ac.ebi.spot.ontostring.domain.mapping.OntologyTerm;
import uk.ac.ebi.spot.ontostring.rest.assembler.OntologyTermDtoAssembler;
...
public class MappingsControllerTest extends IntegrationTest {
    ...
    public void shouldCreateMapping() throws Exception {
        ...
        Assert.assertEquals(1, actualEntity.getMapping().getOntologyTerms().size());
        Assert.assertEquals("Achondroplasia", actualEntity.getMapping().getOntologyTerms().get(0).getLabel());
        Assert.assertEquals("MONDO:0007037", actualEntity.getMapping().getOntologyTerms().get(0).getCurie());
        ...
        Assert.assertEquals(sourceDto.getId(), actualEntity.getSource().getId());
    ...
    public void shouldUpdateMapping() throws Exception {
        ...
        assertNotNull(actualEntity.getMapping());
        Assert.assertEquals(2, actualEntity.getMapping().getOntologyTerms().size());
    ...
    public void shouldDeleteMapping() throws Exception {
        ...
        Assert.assertEquals("Orphanet:15", actualEntity.getMappingSuggestions().get(0).getOntologyTerm().getCurie());
